...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky top-60 w-full", className)}>
            {/* We don't render the default text, just the SVG illustration */}
            <svg
                width="1440"
                height="890"
                viewBox="0 0 1440 890"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute -top-20 inset-x-0 w-full h-[800px] pointer-events-none opacity-60"
            >
                <motion.path
